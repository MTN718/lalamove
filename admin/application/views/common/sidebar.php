    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar" style="height: auto;">
        ...
        <ul class="sidebar-menu">
          ...
          <?php
          if ($data['pageName'] == "NOTIFICATIONS")
              echo "<li class='active'>";
          else
              echo "<li>";
          ?>            
          ...
          <?php
          if ($data['pageName'] == "BUSSINESSLISTER")
              echo "<li class='active'>";
          else
              echo "<li>";
          ?>            
          <a href="<?php echo base_url();?>index.php/home/bussiness">
              <i class="fa fa-users"></i> <span>Bussiness Lister</span>            
          </a>
          </li>  
          <?php
          if ($data['pageName'] == "SETTINGS")
              echo "<li class='active'>";
          else
              echo "<li>";
          ?>            
