        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar" style="height: auto;">
                ...
                <ul class="sidebar-menu">
                    ...
                    <?php switch ($this->userInfo->party_type_id) {
                        case "admin";
                    ?>
                        ...
                        <?php echo($data['pageName'] == "DASHBOARD" ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo base_url(); ?>index.php/admin">
                                <i class="fa fa-home"></i> <span><?php echo $this->lang->line('Dashboard'); ?></span>
                            </a>
                        </li>
                        ...
                        <?php echo($data['pageName'] == "DRIVERS" ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo base_url(); ?>index.php/admin/drivers">
                                <i class="fa fa-users"></i> <span>Drivers</span>
                            </a>
                        </li>
                        <?php echo($data['pageName'] == "BUSINESSLISTERS" ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo base_url(); ?>index.php/admin/businesslisters">
                        ...
                        <?php echo($data['pageName'] == "VEHICLESTYPE" ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo base_url(); ?>index.php/admin/vehicleType">
                                <i class="fa fa-car"></i> <span>Vehicle Type</span>
                            </a>
                        </li>
                        <?php echo($data['pageName'] == "ADDITIONALSERVICES" ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo base_url(); ?>index.php/admin/additionalServices">
                                <i class="fa fa-car"></i> <span>Vehicle Additional Services</span>
                            </a>
                        </li>
                        ...
                        <?php echo($data['pageName'] == "ORDERSADDITIONALSERVICES" ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo base_url(); ?>index.php/admin/orderAdditionalServices">
                                <i class="fa fa-shopping-cart"></i> <span>Orders Additional Services</span>
                            </a>
                        </li>
                        <?php echo($data['pageName'] == "INVOICES" ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo base_url(); ?>index.php/admin/invoices">
                    ...
                    <?php break;
                        ...
                        <?php echo($data['pageName'] == "ACCOUNT" ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo base_url(); ?>index.php/business/account">
                                <i class="fa fa-user"></i> <span>Account</span>
                            </a>
                        </li>
                        <?php echo($data['pageName'] == "NOTIFICATIONS" ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo base_url(); ?>index.php/business/notifications">
                                <i class="fa fa-bell-o"></i> <span>Notifications</span>
                            </a>
                        </li>
                        <?php echo($data['pageName'] == "DRIVERS" ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo base_url(); ?>index.php/business/drivers">
                                <i class="fa fa-users"></i> <span>Drivers</span>
                            </a>
                        </li>
                        <?php echo($data['pageName'] == "VEHICLES" ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo base_url(); ?>index.php/business/vehicles">
                                <i class="fa fa-car"></i> <span>Vehicles</span>
                            </a>
                        </li>
                        <?php echo($data['pageName'] == "ORDERS" ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo base_url(); ?>index.php/business/orders">
                                <i class="fa fa-shopping-cart"></i> <span>Orders</span>
                            </a>
                        </li>
                        <?php echo($data['pageName'] == "BIDDINGPANEL" ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo base_url(); ?>index.php/business/bidding">
                                <i class="fa fa-bell-o"></i> <span>Bidding Panel</span>
                            </a>
                        </li>
