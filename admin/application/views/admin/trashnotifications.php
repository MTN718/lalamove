          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="<?php echo base_url(); ?>index.php/admin/notifications"><i class="fa fa-inbox"></i> Inbox
                  ...
                  <li class="active"><a href="<?php echo base_url(); ?>index.php/admin/trashNotifications"><i
          ...
          <div class="col-md-9">
            <div class="box box-primary">
              ...
              <div class="box-body table-responsive" style="margin-top: -54px;">
                <form id="deleteMail" action="<?php echo base_url();?>index.php/admin/deleteMail/trash" method="POST">
                      ...
                      <tr>
                        ...
                        <td class="mailbox-subject"><b><?php echo $notification->subject; ?></b> - 
                          ...
                          if (strlen($notification->message) < 60)
                            ...
                            echo substr($notification->message, 0, 57) . " . . . "."<a href='index.php/admin/readMail?mail_id=$notification->notification_id' style='color: #f66f3d;'>continue reading</a>";
                          ?>
                        </td>
