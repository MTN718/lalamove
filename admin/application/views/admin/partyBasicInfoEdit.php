...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/admin/updateUserInfo/<?php echo $data['status']; ?>" method="POST">
        ...
        <?php } else { ?>
        <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/admin/addUserInfo/<?php echo $data['status']; ?>" method="POST">
                    ...
                    <div class="box box-primary">
                        ...
                        <?php if (isset($data['partyUserNameInfo'])) {
                            if ($data['partyNameInfo']->party_type_id == "customer") { ?>
                                ...
                                <a href="<?php echo base_url(); ?>index.php/admin/customerOverview/<?php echo $data['status']; ?>?party_id=<?php echo $data['partyNameInfo']->party_id; ?>" class="btn btn-default float__right"><i class="fa fa-reply"></i></a>

                            <?php }
                            if ($data['partyNameInfo']->party_type_id == "driver") { ?>

                                <h3 class='box-title'>Edit Basic Info of Driver</h3>
                                <a href="<?php echo base_url(); ?>index.php/admin/driverOverview/<?php echo $data['status']; ?>?party_id=<?php echo $data['partyNameInfo']->party_id; ?>" class="btn btn-default float__right"><i class="fa fa-reply"></i></a>

                            <?php }
                            if ($data['partyNameInfo']->party_type_id == "business") { ?>

                                <h3 class='box-title'>Edit Basic Info of Driver</h3>
                                <a href="<?php echo base_url(); ?>index.php/admin/businessOverview/<?php echo $data['status']; ?>?party_id=<?php echo $data['partyNameInfo']->party_id; ?>" class="btn btn-default float__right"><i class="fa fa-reply"></i></a>

                            <?php }
                        } else if ($data['partyTypeInfo'] == "customer") { ?>

                            <h3 class='box-title'>Add Customer</h3>
                            <a href="<?php echo base_url(); ?>index.php/admin/customers" class="btn btn-default float__right"><i class="fa fa-reply"></i></a>

                        <?php } else if ($data['partyTypeInfo'] == "driver") { ?>

                            <h3 class='box-title'>Add Driver</h3>
                            <?php if($data['status'] == "business") { ?>
                                <a href="<?php echo base_url(); ?>index.php/admin/businessOverview?party_id=<?php echo $data['owner_id']; ?>" class="btn btn-default float__right"><i class="fa fa-reply"></i></a>
                            <?php } else { ?>
                                <a href="<?php echo base_url(); ?>index.php/admin/drivers" class="btn btn-default float__right"><i class="fa fa-reply"></i></a>
                            <?php } ?>

                        <?php } else if ($data['partyTypeInfo'] == "business") { ?>

                            <h3 class='box-title'>Add Business Lister</h3>
                            <a href="<?php echo base_url(); ?>index.php/admin/business" class="btn btn-default float__right"><i class="fa fa-reply"></i></a>
                            ...
                            <?php if ($data['partyTypeInfo'] == "driver") { ?>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php if(empty($data['owner_id'])) { ?>
                                        <div class="form-group col-sm-12 col-md-12">
                                            <label class="col-sm-2 control-label asterisk">Trainee</label>
                                            <div class="col-md-10">
                                            <div class="col-xs-3" style="padding: 0px;">
                                                <div class="radio-inline">
                                                    <label>
                                                    <input type="radio" class="owner-case" name="owner_case_status" data="yes" value="yes" required="required" <?php if (isset($data['partyNameInfo']->external_id) AND $data['partyNameInfo']->external_id == NULL) echo 'checked'; ?>>
                                                    Yes</label>
                                                </div>
                                                <div class="radio-inline">
                                                    <label>
                                                    <input type="radio" class="owner-case" name="owner_case_status" data="no" value="no" required="required" <?php if (isset($data['partyNameInfo']->external_id) AND $data['partyNameInfo']->external_id != NULL) echo 'checked'; ?>>
                                                    No</label>
                                                </div>
                                            </div>
                                            <div class="col-xs-9" style="padding: 0px;">
                                                <?php if (isset($data['partyNameInfo']->external_id) AND $data['partyNameInfo']->external_id != NULL) { ?>
                                                    <div id="owner_case_no_input">                                        
                                                            <select class="form-control select2" id="driver" col-index='0' data-placeholder="Select Owner" name="external_id" required="required">
                                                                <option value="">Select Owner</option>
                                                                    <?php foreach ($data['partyBusinessList'] as $partyBusiness) { 
                                                                    $str_flag = "";
                                                                    if($data['partyNameInfo']->external_id == $partyBusiness->party_id)
                                                                        $str_flag = "selected"; 
                                                                ?>
                                                    ...
                                                    <?php } else { ?>
                                                        <div id="owner_case_no_input"></div>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } else { ?>
                                        <input type="hidden" name="external_id" value="<?php echo $data['owner_id'];?>">
                                        <?php } ?>
                                    </div>
                                </div>
        ...
        <?php if (isset($data['partyUserNameInfo']) and $data['partyTypeInfo'] != "driver") { ?>
                        ...
                        <div class="box-body">
                            <div class="row">
                                <form action="<?php echo base_url();?>index.php/business/updatePartyPassword" method="POST">
                                    ...
                                    <input type="hidden" name="party_type_id" value="<?php echo $data['partyNameInfo']->party_type_id; ?>">
                                    <div class="form-group col-sm-12 col-md-12">
