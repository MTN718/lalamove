...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>index.php/admin/drivers"><i class="fa fa-dashboard"></i> admin</a></li>
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <a href="<?php echo base_url(); ?>index.php/admin/partyBasicInfoEdit/<?php echo $data['status']; ?>?party_id=<?php echo $data['partyUserNameInfo']->party_id; ?>"
             type="button" class="btn btn-info"><i class="fa fa-pencil"></i></a>

          <?php if($data['status'] == "business") { ?>
            <a href="<?php echo base_url(); ?>index.php/admin/businessOverview?party_id=<?php echo $data['partyNameInfo']->external_id; ?>" class="btn btn-default"><i class="fa fa-reply"></i></a>
          <?php } else { ?>
            <a href="<?php echo base_url(); ?>index.php/admin/drivers" class="btn btn-default"><i class="fa fa-reply"></i></a>
          <?php } ?>        
                          ...
                          <td>
                            ...
                            <td>
                              <?php if(!empty($order->vehicle_id)) { 
                                ...
                                ?>
                                <a href="<?php echo base_url(); ?>index.php/admin/vehicle/<?php echo $order->vehicle_id ?>" style="color:#f16622;">
                                  <?php
