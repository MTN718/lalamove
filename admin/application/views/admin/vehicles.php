                                ...
                                <tr data-row-id="<?php echo $vehicle->vehicle_id;?>" <?php if($vehicle->vehicle_id == $data['status']) echo "style='background:#ffbfbf'";;?>>
                                    ...
                                    <td style="background-color: #FFBFBF;">             
                                        <select class="form-control select2 editable-col" col-index='6' data-placeholder="Select vehicle Type" name="driver_id" style="width: 100%">
                                            ...
                                            <?php foreach ($partyDriverList as $partyDriver) { 
                                                $str_flag = "";
    ...
    <div class="modal fade" id="addvehicleDialog" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">                        
                ...
                <form id='addvehicleForm' method="post" action="<?php echo base_url();?>index.php/admin/addvehicleInfo" enctype="multipart/form-data"> 
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label for="driver" class="control-label">Owner:</label>
                                    <select class="form-control select2" col-index='0' id="business" data-placeholder="Select vehicle Type" name="party_id" required="required">
                                        <option value="">Select Owner</option>
                                        <?php foreach ($data['partyBusinessList'] as $partyBusiness) { ?>
                                        <option value="<?php echo $partyBusiness->party_id; ?>"> <?php echo $partyBusiness->first_name; ?> <?php echo $partyBusiness->last_name; ?> </option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
