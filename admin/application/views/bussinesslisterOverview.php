<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Bussiness Overview</h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url();?>index.php/home/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Bussiness Overview</li>
        </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="<?php echo base_url();?>index.php/home/partyBasicInfoEdit?PARTY_ID=<?php echo $data['partyUserNameInfo']->PARTY_ID;?>" type="button" class="btn btn-info"><i class="fa fa-pencil"></i></a>
                    <a href="<?php echo base_url();?>index.php/home/bussiness" class="btn btn-default"><i class="fa fa-reply"></i></a>
                </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <?php if(!empty($data['partyNameInfo']->FIRST_NAME)) echo $data['partyNameInfo']->FIRST_NAME; ?>&nbsp;<?php if(!empty($data['partyNameInfo']->LAST_NAME)) echo $data['partyNameInfo']->LAST_NAME; ?>
                        </div>   
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <?php if(!empty($data['partyTelecomInfo']->AREA_CODE)) echo $data['partyTelecomInfo']->AREA_CODE; ?> - <?php if(!empty($data['partyTelecomInfo']->CONTACT_NUMBER)) echo $data['partyTelecomInfo']->CONTACT_NUMBER; ?>
                        </div>  
                    </div>
                </div>
                <div class="row">
