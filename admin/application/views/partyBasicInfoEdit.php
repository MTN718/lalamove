<div class="content-wrapper">
  <section class="content">
    ...
    <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/home/updateUserInfo" method="POST">
      <input type="hidden" name="PARTY_TYPE_ID"
             value="<?php if (!empty($data['partyNameInfo'])) echo $data['partyNameInfo']->PARTY_TYPE_ID; ?>">
      <input type="hidden" name="PARTY_ID"
             value="<?php if (!empty($data['partyNameInfo'])) echo $data['partyNameInfo']->PARTY_ID; ?>">
        <?php } else { ?>
      <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/home/addUserInfo" method="POST">
        <input type="hidden" name="PARTY_TYPE_ID"
               value="<?php if (!empty($data['partyTypeInfo'])) echo $data['partyTypeInfo']; ?>">
              ...
              <div class="box-header">
                  ...
                  <?php if (isset($data['partyUserNameInfo'])) {
                      ...
                      if ($data['partyNameInfo']->PARTY_TYPE_ID == "CUSTOMER") { ?>
                        ...
                        <a href="<?php echo base_url(); ?>index.php/home/customerOverview?PARTY_ID=<?php echo $data['partyNameInfo']->PARTY_ID; ?>"
                           class="btn btn-default float__right"><i class="fa fa-reply"></i></a>

                      <?php }
                      if ($data['partyNameInfo']->PARTY_TYPE_ID == "DRIVER") { ?>

                        <h3 class='box-title'>Edit Basic Info of Driver</h3>
                        <a href="<?php echo base_url(); ?>index.php/home/driverOverview?PARTY_ID=<?php echo $data['partyNameInfo']->PARTY_ID; ?>"
                           class="btn btn-default float__right"><i class="fa fa-reply"></i></a>
                      ...
                      if ($data['partyNameInfo']->PARTY_TYPE_ID == "BUSINESS") { ?>
                        ...
                        <h3 class='box-title'>Edit Basic Info of Driver</h3>
                        <a href="<?php echo base_url(); ?>index.php/home/businessOverview?PARTY_ID=<?php echo $data['partyNameInfo']->PARTY_ID; ?>"
                           class="btn btn-default float__right"><i class="fa fa-reply"></i></a>
                    ...
                    <a href="<?php echo base_url(); ?>index.php/home/customers" class="btn btn-default float__right"><i
                          class="fa fa-reply"></i></a>

                  <?php } else if ($data['partyTypeInfo'] == "DRIVER") { ?>

                    <h3 class='box-title'>Add Driver</h3>
                    <a href="<?php echo base_url(); ?>index.php/home/drivers" class="btn btn-default float__right"><i
                          class="fa fa-reply"></i></a>

                  <?php } else if ($data['partyTypeInfo'] == "BUSINESS") { ?>

                    <h3 class='box-title'>Add Business Lister</h3>
                    <a href="<?php echo base_url(); ?>index.php/home/business" class="btn btn-default float__right"><i
                          class="fa fa-reply"></i></a>
                    ...
                    <div class="col-md-10">
                        <?php if (isset($data['partyNameInfo']->FIRST_NAME)) { ?>
                          <input type="text" class="form-control" name="FIRST_NAME"
                                 value="<?php if (!empty($data['partyNameInfo']->FIRST_NAME)) echo $data['partyNameInfo']->FIRST_NAME; ?>"
                                 required="required">
                        <?php } else { ?>
                    ...
                    <div class="col-md-10">
                        <?php if (isset($data['partyNameInfo']->LAST_NAME)) { ?>
                          <input type="text" class="form-control" name="LAST_NAME"
                                 value="<?php if (!empty($data['partyNameInfo']->LAST_NAME)) echo $data['partyNameInfo']->LAST_NAME; ?>">
                        <?php } else { ?>
                          <input type="text" class="form-control" name="LAST_NAME">
                        <?php } ?>
                    </div>
                  ...
                  <div class="form-group col-sm-6 col-md-6">
                    ...
                    <div class="col-md-10">
                        <?php if (isset($data['partyEmailInfo']->INFO_STRING)) { ?>
                          <input type="text" class="form-control" name="INFO_STRING"
