        ...
        <div class="box box-primary">
          <div class="box-header">
            <div class="row">
              ...
              <div class="col-sm-6 col-md-6">
                <a href="<?php echo base_url(); ?>index.php/business/addpartyDriver"
            ...
            <table id="example1" class="table table-bordered table-hover">
              ...
              <?php foreach ($data['partyDriverList'] as $driver) { ?>
                <tr data-row-id="<?php echo $driver->party_id; ?>">
                  ...
                  <td>
                    <a href="<?php echo base_url(); ?>index.php/business/driverOverview?party_id=<?php echo $driver->party_id; ?>" style="color:#f16622;">
                  ...
                  <td class="text__align__right">
                    ...
                    <?php } ?>
                    <a href="<?php echo base_url(); ?>index.php/business/driverOverview?party_id=<?php echo $driver->party_id; ?>"
                       class="btn btn-info"><i class="fa fa-pencil"></i></a>
                    <a href="<?php echo base_url(); ?>index.php/business/partyDelete?party_id=<?php echo $driver->party_id; ?>"
    ...
    $(document).ready(function(){      
      $('.editable-action').on('click', function() {
        ...
        $.ajax({   
            ...
            type: "POST",  
            url: "<?php echo base_url(); ?>/index.php/business/updateInline/drivers",  
            cache:false,  
            data: data,
            dataType: "json",       
