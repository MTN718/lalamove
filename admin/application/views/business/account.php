          ...
          <div class="box-body box-profile">
            ...
            <ul class="list-group list-group-unbordered">
              <li class="list-group-item">
                <b>vehicle</b> <a class="pull-right"><?php echo $data['noOfVehicle']; ?></a>
              </li>
              <li class="list-group-item">
              ...
              <ul class="timeline timeline-inverse">
                ...
                for ($i = 0; $i < 7; $i++) { 
                  ...
                  <div class="tab-pane <?php if ($data['active'] == "password") echo "active"; ?>" id="password">
                    <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/business/updateUserPasswordInfo" method="POST">
                  ...
                  <div class="tab-pane <?php if ($data['active'] == "setting") echo "active"; ?>" id="settings">
                    <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/business/updateUserInfo" method="POST">
                  ...
                  <div class="tab-pane <?php if ($data['active'] == "profilepicture") echo "active"; ?>"
                   ...
                   <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/business/updateUserPictureInfo" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="party_id"
                    value="<?php if (!empty($data['partyid'])) echo $data['partyid']; ?>">
                    <div class="form-group">
                      <div class="col-md-10">
