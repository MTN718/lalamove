    ...
    <div class="content-wrapper">
        ...
        <section class="invoice">
            ...
            <div class="row">
                        ...
                        <select class="form-control" name="orderService[]" multiple id="orderService" order_id="<?php echo $data['orderInfo']->order_id; ?>" required="required">    
                            <?php foreach ($data['orderServiceList'] as $orderService) { 
                                ...
                                <option value="<?php echo $orderService->service_id; ?>" <?php echo $str_flag; ?> >
                                    <?php echo $orderService->services_title; ?>
                                </option>
                            <?php } ?>
                        </select>
                        <br>
                ...
                <!-- /.col -->
                <div class="col-xs-6">
                    <p class="lead">Order Extra Charge</p>
...
<script>
    ...
    function orderTotal() {     
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo base_url();?>index.php/business/orderTotalUpdate',
            data: data,
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $.ajax({ 
            type: "POST",  
            url: "<?php echo base_url(); ?>/index.php/business/orderServiceInlineUpdate",  
            cache:false,  
            data: data,
            dataType: "json",       
    ...
    $(document).ready(function(){      
      $(document).on('focusout','td.editable-col', function() {
        ...
        $.ajax({   
            ...
            type: "POST",  
            url: "<?php echo base_url(); ?>index.php/business/orderInlineUpdate",  
            cache:false,  
            data: data,
            dataType: "json",       
            success: function(response)  
