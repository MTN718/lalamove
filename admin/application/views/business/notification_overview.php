 ...
 <div class="content-wrapper" style="min-height: 946px;">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url();?>index.php/business/composeMail"><i class="fa fa-dashboard"></i> admin</a></li>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-3">
        <a href="<?php echo base_url();?>index.php/business_controller/compose" class="btn btn-primary btn-block margin-bottom">Compose</a>
        <div class="box box-solid">
          ...
          <div class="box-body no-padding">
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="<?php echo base_url(); ?>index.php/business/notifications"><i
                  ...
                  <li><a href="<?php echo base_url(); ?>index.php/business/trashNotifications"><i class="fa fa-trash-o"></i>
                    Trash
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            ...
            <div class="box-footer">
              <a href="<?php echo base_url();?>index.php/business/deleteReadMail?mail_id=<?php echo $data['notificationInfo']->notification_id;?>"><button type="button" class="btn btn-default"><i class="fa fa-trash-o"></i> Delete</button></a>
              <!-- <a href="<?php echo base_url();?>index.php/business/sendnotificationmail?mail_id=<?php echo $data['notificationInfo']->notification_id;?>"><button type="button" class="btn btn-default"><i class="fa fa-envelope-o"></i> Email</button></a> -->
            </div>
          </div>
        </div>
      </div>
