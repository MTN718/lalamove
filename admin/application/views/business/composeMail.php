 ...
 <div class="content-wrapper" style="min-height: 946px;">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url();?>index.php/business/dashboard"><i class="fa fa-dashboard"></i> admin</a></li>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-3">
        <a href="<?php echo base_url();?>index.php/business/notifications" class="btn btn-primary btn-block margin-bottom">BacK to Inbox</a>
          ...
          <div class="box-body no-padding">
            ...
            <div class="col-md-9">
              <div class="box box-primary">
                ...
                <form action="<?php echo base_url();?>index.php/business/sendMail" method="POST">
                  <div class="box-body">
