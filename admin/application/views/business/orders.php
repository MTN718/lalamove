                                ...
                                <?php foreach ($data['orderList'] as $order) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo base_url(); ?>index.php/business/driverOverview?party_id=<?php echo $order->driver_id ?>" style="color:#f16622;">
                                            <?php                                            
                                                $this->db->select('*');
                                                $this->db->from('person');
                                        ...
                                        <td><?php if (!empty($order->bid_amount)) echo $order->bid_amount; ?></td>
                                        <td>
