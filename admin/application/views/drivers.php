                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <a href="<?php echo base_url();?>index.php/home/addPartyDriver" class="btn btn-primary text__align__right floatalign_text_right"><i class="fa fa-plus"></i></a>
                            </div>  
                        </div>  
                    </div>
                    <!-- /.box-header -->
                            ...
                            <?php foreach ($data['partyDriverList'] as $driver) { ?>
                                <tr>
                                    <td>
                                        ...
                                        <?php } else { ?>
                                        <img class="profile-user-img img-responsive img-circle user__img" src='<?php echo base_url();?>images/<?php echo $driver->PERSON_IMAGE_URL; ?>'/>  
                                        <?php } ?>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text__align__right">
                                        <a href="<?php echo base_url();?>index.php/home/driverOverview?PARTY_ID=<?php echo $driver->PARTY_ID?>" class="btn btn-info"><i class="fa fa-pencil"></i></a> 
                                        <a href="<?php echo base_url();?>index.php/home/partyDelete?PARTY_ID=<?php echo $driver->PARTY_ID; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a> 
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>            
