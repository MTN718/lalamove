        ...
        <div class="box box-primary">
          <div class="box-header">
            <div class="row">
              ...
              <div class="col-sm-6 col-md-6">
                <a href="<?php echo base_url(); ?>index.php/home/addPartyBusiness"
            ...
            <table id="example1" class="table table-bordered table-hover">
              ...
              <?php foreach ($data['partyBusinessList'] as $business) { ?>
                <tr>
                  ...
                  <td>
                    <a href="<?php echo base_url(); ?>index.php/home/businessOverview?PARTY_ID=<?php echo $business->PARTY_ID ?>">
                        <?php if (!empty($business->FIRST_NAME)) echo $business->FIRST_NAME; ?><?php if (!empty($business->LAST_NAME)) echo $business->LAST_NAME; ?>
                    </a>
                  </td>
                  <td><?php if (!empty($business->USER_LOGIN_ID)) echo $business->USER_LOGIN_ID; ?></td>
                  <td></td>
                  <td></td>
                  <td class="text__align__right">
                    <a href="<?php echo base_url(); ?>index.php/home/businessOverview?PARTY_ID=<?php echo $business->PARTY_ID ?>"
                       class="btn btn-info"><i class="fa fa-pencil"></i></a>
                    <a href="<?php echo base_url(); ?>index.php/home/partyDelete?PARTY_ID=<?php echo $business->PARTY_ID; ?>"
