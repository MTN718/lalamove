        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="tab-pane <?php if ($data['active'] == "about_us") echo "active"; ?>" id="about_us">
              <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/home/updateWebSettings"
                    method="POST">
            ...
            <div class="tab-pane <?php if ($data['active'] == "privacy_policy") echo "active"; ?>" id="privacy_policy">
              <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/home/updateWebSettings"
                    method="POST">
                <input type="hidden" name="ID"
                       value="<?php if (!empty($data['webPrivacyPolicy']->PRIVACY_POLICY_ID)) echo $data['webPrivacyPolicy']->PRIVACY_POLICY_ID; ?>">
            ...
            <div class="tab-pane <?php if ($data['active'] == "term_condition") echo "active"; ?>" id="term_condition">
              <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/home/updateWebSettings"
                    method="POST">
                <input type="hidden" name="ID"
                       value="<?php if (!empty($data['webTermCondtion']->TERM_CONDITION_ID)) echo $data['webTermCondtion']->TERM_CONDITION_ID; ?>">
            ...
            <div class="tab-pane <?php if ($data['active'] == "faqs_update") echo "active"; ?>">
              <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/home/updateWebSettings"
                ...
                <div class="modal-footer">
                  ...
                  <a href="<?php echo base_url(); ?>index.php/home/settings/faqs" class="btn btn-default">Back</a>
                </div>
              </form>
            </div>
            ...
            <div class="tab-pane <?php if ($data['active'] == "faqs") echo "active"; ?>" id="faqs">
              <div class="row">
                ...
                <div class="col-sm-6 col-md-6">
                  <a href="<?php echo base_url(); ?>index.php/home/settings/faqs_update"
                  ...
                  <tr>
                    ...
                    <td class="text__align__right">
                        <?php if ($webFaqs->STATUS == 0) { ?>
                          <a href="<?php echo base_url(); ?>index.php/home/faqs_status/Enable?FAQ_ID=<?php echo $webFaqs->FAQ_ID; ?>"
                             class="btn btn-info">
                            <i class="fa fa-thumbs-up"></i>
                          </a>
                        <?php } else { ?>
                          <a href="<?php echo base_url(); ?>index.php/home/faqs_status/Disable?FAQ_ID=<?php echo $webFaqs->FAQ_ID; ?>"
                             class="btn btn-default">
                            <i class="fa fa-thumbs-down"></i>
                          </a>
                        <?php } ?>
                      <a href="<?php echo base_url(); ?>index.php/home/webFaqsEdit?FAQ_ID=<?php echo $webFaqs->FAQ_ID; ?>"
                         class="btn btn-primary">
                        <i class="fa fa-pencil"></i>
                      </a>
                      <a href="<?php echo base_url(); ?>index.php/home/faqs_status/Delete?FAQ_ID=<?php echo $webFaqs->FAQ_ID; ?>"
