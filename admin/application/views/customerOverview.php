<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>index.php/home/customers"><i class="fa fa-dashboard"></i> Home</a></li>
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          ...
          <a href="<?php echo base_url(); ?>index.php/home/customers" class="btn btn-default"><i
