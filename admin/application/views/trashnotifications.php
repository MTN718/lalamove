        ...
        <div class="box box-solid">
          ...
          <div class="box-body no-padding">
            <ul class="nav nav-pills nav-stacked">
              ...
              <li><a href="<?php echo base_url(); ?>index.php/home/sentNotifications"><i class="fa fa-envelope-o"></i>
                  Sent
                  <span class="label label-info pull-right"><?php echo $data['sentNotificationCount']; ?></span></a>
              </li>
              <li class="active"><a href="<?php echo base_url(); ?>index.php/home/trashNotifications"><i
        ...
        <div class="box box-primary">
          ...
          <!-- <div class="box-body table-responsive" style="margin-top: -54px;">
                        <table  id="example22" class="table table-hover table-striped" style="margin-top: 12px !important;">
                            ...
                            <tbody>
                                <form id="per_deleteMail" action="<?php echo base_url(); ?>index.php/admin_controller/per_deleteMail" method="POST">
                                    <?php foreach ($trashnotificationinfo as $notification) {
              $this->db->select('*');
              $this->db->from('users');
              ...
              ?>
                                    <tr>
                                        <td><input type="checkbox" name="mail[]" value="<?php echo $notification->mail_id; ?>"></td>
