...
--
-- Host: localhost
-- Generation Time: Aug 19, 2017 at 06:29 PM
...
INSERT INTO `ORDER` (`ORDER_ID`, `ORDER_DATE`, `ORDER_BY`, `ORDER_PRICE`, `PARTY_ID`, `ITEM_TYPE_ID`, `VEHICLE_TYPE_ID`, `VEHICLE_ID`, `DRIVER_ID`, `DESCRIPTION`, `ORDER_STATUS_ID`, `CREATED_DATE`, `LAST_MODIFIED_DATE`) VALUES
(1, '2017-08-17 10:25:21', 'CUSTOMER', 567, 24, 0, 'MOTORCYCLE', NULL, NULL, 'oks s', 'Cancelled', '2017-08-15 14:58:49', '2017-08-15 14:58:49');
...
(1, 2, ' Demo Name ', '123456', ' Demo Address ', 'demo', 1, 2),
(2, 3, ' Demo Name ', '32131231', ' Demo Address ', 'demo', 2, 3),
(4, 5, ' Demo Name ', '123123213', ' Demo Address ', 'demo', 1, 5),
(5, 4, 'Demo Name', '1232131', ' Demo Address ', '', 0, 0);
...
(2, 1, 'START', 'Indore', '32423', '2342', 12, 0),
(3, 1, 'STOP', 'Indore', '456546', '6575676575', 12, 0),
(4, 1, 'STOP', 'Agar', '23423', '34343', 12, 0),
(5, 1, 'END', 'Kota', '23423', '4546', 12, 0);
...
('MP-09AZ6655', 'MP-09 AZ 6655', 18, '55TON', 'SN-4354ETRE45TBDFJGN', 'INTRASTATE', 0, 1);
...
INSERT INTO `VEHICLE_TYPE` (`VEHICLE_TYPE_ID`, `VEHICLE_TYPE_NAME`, `WORKING_REGION`, `MIN_WEIGHT_CAPACITY`, `MAX_WEIGHT_CAPACITY`, `ITEM_HEIGHT`, `ITEM_WIDTH`, `ITEM_LENGTH`, `BASE_FARE`, `RENT_PER_KM`, `LOAD_UNLOAD_OVERTIME_CHARGE`, `LOAD_UNLOAD_MAX_TIME`, `LANDFILLS_CHARGE`, `CONSTRUCTION_CHARGE`, `NIGHT_CHARGE`, `MIDNIGHT_FEE`, `SUNDAY_PH_CHARGE`, `OWNER_PAYABLE`, `ONG_CHARGE`, `PARKING_FEE`) VALUES
('55TON', '5.5 Ton', 'HONGKOK', 800, 1200, 195, 450, 0, 130, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12),
('MOTORCYCLE', 'Motorcycle', 'BANGKOK', 0, 10, 80, 80, 80, 100, 12, 12, 12, 21, 12, 12, 12, 12, 12, 12, 22),
('VAN', 'Van', 'HONGKOK', 700, 800, 121, 182, 121, 50, 12, 12, 12, 55, 12, 12, 12, 12, 12, 12, 22);
...
--
ALTER TABLE `ORDER_LOCATION`
  MODIFY `ORDER_LOCATION_ID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
