...
--
-- Host: localhost
-- Generation Time: Aug 21, 2017 at 06:10 PM
...
INSERT INTO `ORDER` (`ORDER_ID`, `ORDER_DATE`, `ORDER_BY`, `ORDER_PRICE`, `ORDER_DURATION`, `ORDER_DISTANCE`, `PARTY_ID`, `ITEM_TYPE_ID`, `VEHICLE_TYPE_ID`, `VEHICLE_ID`, `DRIVER_ID`, `DESCRIPTION`, `ORDER_STATUS_ID`, `CREATED_DATE`, `LAST_MODIFIED_DATE`) VALUES
(1, '2017-08-17 10:25:21', 'CUSTOMER', 567, '0', '', 24, 0, 'MOTORCYCLE', 'MP-09AZ6657', 18, 'This is new demo with new order overview. let try it.', 'Cancelled', '2017-08-15 14:58:49', '2017-08-15 14:58:49');
...
CREATE TABLE `ORDER_ADDITIONAL_SERVICES` (
  ...
  `PARENT_SERVICE_ID` int(100) NOT NULL,
  `DESCRIPTION` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `ORDER_DELIVERY_CONTACT` (
  `ORDER_DELIVERY_CONTACT_ID` int(100) NOT NULL,
...
INSERT INTO `ORDER_DELIVERY_CONTACT` (`ORDER_DELIVERY_CONTACT_ID`, `ORDER_LOCATION_ID`, `CONTACT_NAME`, `CONTACT_MOBILE`, `CONTACT_ADDRESS`, `BUILDING_BLOCK`, `FLOOR`, `ROOM`) VALUES
(1, 2, ' Demo Name ', ' 123456 ', ' Demo Address ', 'demo 1212', 4, 4),
(2, 3, ' Demo Name ', ' 32131231 ', ' Demo Address ', 'demo 1234', 4, 6),
(4, 5, ' Demo Name ', ' 123123213 ', ' Demo Address ', 'demo 1234', 9, 9),
(5, 4, 'Demo Name', ' 1232131 ', ' Demo Address ', 'demo 1234', 5, 7);
...
CREATE TABLE `ORDER_LOCATION` (
  ...
  `STOP_TIME` int(100) NOT NULL DEFAULT '30',
...
(2, 1, 'START', 'Indore', '32423', '2342', 13, 12),
(3, 1, 'STOP', 'Indore', '456546', '6575676575', 13, 12),
(4, 1, 'STOP', 'Agar', '23423', '34343', 13, 12),
(5, 1, 'END', 'Kota', '23423', '4546', 13, 12);
...
('MP-09AZ6655', 'MP-09 AZ 6655', 17, 'MOTORCYCLE', 'SN-4354ETRE45TBDFJGN', 'INTRASTATE', 0, 1),
('MP-09AZ6657', 'MP-09 AZ 6657', 18, 'MOTORCYCLE', 'SN-435ERT54R5TBDFJGN', 'INTRASTATE', 0, 1);
...
CREATE TABLE `VEHICLE_TYPE` (
  ...
  `VEHICLE_TYPE_CLASS` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `VEHICLE_TYPE` (`VEHICLE_TYPE_ID`, `VEHICLE_TYPE_NAME`, `WORKING_REGION`, `MIN_WEIGHT_CAPACITY`, `MAX_WEIGHT_CAPACITY`, `ITEM_HEIGHT`, `ITEM_WIDTH`, `ITEM_LENGTH`, `BASE_FARE`, `RENT_PER_KM`, `LOAD_UNLOAD_OVERTIME_CHARGE`, `LOAD_UNLOAD_MAX_TIME`, `LANDFILLS_CHARGE`, `CONSTRUCTION_CHARGE`, `NIGHT_CHARGE`, `MIDNIGHT_FEE`, `SUNDAY_PH_CHARGE`, `OWNER_PAYABLE`, `ONG_CHARGE`, `PARKING_FEE`, `ORDER_BY`, `IMAGE1`, `IMAGE2`, `VEHICLE_TYPE_CLASS`) VALUES
('55TON', '5.5 Ton', 'HONGKOK', 800, 1200, 195, 450, 0, 130, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 0, '', '', ''),
('MOTORCYCLE', 'Motorcycle', 'BANGKOK', 0, 10, 80, 80, 80, 100, 12, 12, 12, 21, 12, 12, 12, 12, 12, 12, 22, 0, '', '', ''),
('VAN', 'Van', 'HONGKOK', 700, 800, 121, 182, 121, 50, 12, 12, 12, 55, 12, 12, 12, 12, 12, 12, 22, 0, '', '', '');
...
ALTER TABLE `ORDER_DELIVERY_CONTACT`
  ADD PRIMARY KEY (`ORDER_DELIVERY_CONTACT_ID`);
...
--
ALTER TABLE `ORDER_DELIVERY_CONTACT`
  MODIFY `ORDER_DELIVERY_CONTACT_ID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `ORDER_LOCATION`
--
ALTER TABLE `ORDER_LOCATION`
  MODIFY `ORDER_LOCATION_ID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `ORDER_SERVICES_CONN`
--
ALTER TABLE `ORDER_SERVICES_CONN`
  MODIFY `ORDER_SERVICES_CONN_ID` int(100) NOT NULL AUTO_INCREMENT;
--
